...
urlpatterns = (
    ...
    url(r'^mitarbeiter/neuerMA/$', MyA.views.details_employee, name='newEmployee'),
    url(r'^mitarbeiter/editMa/(?P<pk>[0-9]+)/change//?$', MyA.views.details_employee, name='editEmployee'),
    url(r'^mitarbeiter/editMa/(?P<pk>[0-9]+)/password//?$', MyA.views.set_password, name='setPasswordForUser'),
    url(r'^mitarbeiter/deleteMa/(?P<pk>[0-9]+)/?$', MyA.views.delete_employee, name='deleteEmployee'),
    url(r'^mitarbeiter/toggleMa/(?P<pk>[0-9]+)/?$', MyA.views.toggle_employee_active, name='toggleEmployee'),
